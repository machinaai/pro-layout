...
// Renderizar nodos secundarios de breadcrumbs
...
export const getBreadcrumb = (
  ...
  if (!breadcrumbItem) {
    ...
    // Encuentre la primera ruta coincidente en el orden definido por la configuración de ruta
    const targetPath = [...breadcrumbMap.keys()].find((path) =>
      // remover ? ,De lo contrario, se repetirá
...
/**
 * Convertir Parámetro en breadcrumbs
 */
